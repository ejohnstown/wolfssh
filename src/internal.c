...
Flags:
  ...
  WOLFSSH_NO_DH_GROUP14_SHA256
    ...
    and SHA256 support.
  WOLFSSH_NO_DH_GROUP15_SHA512
    Set when DH or SHA512 are disabled. Set to disable use of DH (Oakley 15)
    and SHA512 support.
...
#endif
#if !defined(WOLFSSH_NO_DH_GROUP15_SHA512)
...
#endif
#ifndef WOLFSSH_NO_DH_GROUP15_SHA512
    { ID_DH_GROUP15_SHA512, TYPE_KEX, "diffie-hellman-group15-sha512" },
#endif
...
#if !defined(WOLFSSH_NO_DH_GROUP15_SHA512)
static const byte dhPrimeGroup15[] = {
    /* SSH DH Group 15 (3072-bit MODP Group, RFC 3526) */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
    0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74,
...
static const word32 dhPrimeGroup15Sz = (word32)sizeof(dhPrimeGroup15);
#endif

#if !defined(WOLFSSH_NO_DH_GROUP16_SHA512)
static const byte dhPrimeGroup16[] = {
    /* SSH DH Group 16 (4096-bit MODP Group, RFC 3526) */
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
    0xC9, 0x0F, 0xDA, 0xA2, 0x21, 0x68, 0xC2, 0x34,
    0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C, 0xD1,
    0x29, 0x02, 0x4E, 0x08, 0x8A, 0x67, 0xCC, 0x74,
    ...
    word32* primeGroupSz, const byte** generator, word32* generatorSz)
{
    ...
    switch (kexId) {
        ...
        #ifndef WOLFSSH_NO_DH_GROUP15_SHA512
        case ID_DH_GROUP15_SHA512:
            *primeGroup = dhPrimeGroup15;
            *primeGroupSz = dhPrimeGroup15Sz;
            *generator = dhGenerator;
            *generatorSz = dhGeneratorSz;
            break;
        #endif
